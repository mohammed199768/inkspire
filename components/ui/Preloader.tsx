        ...
        <AnimatePresence>
            {loading && (
                ...
                >
                    ...
                    <motion.div
                        className="mb-8 md:mb-12 relative w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96"
                    ...
                    >
                        ...
                        <Image
                            ...
                            priority
                            quality={100}
                            sizes="(max-width: 768px) 300px, 800px" // Request higher resolution for sharpness
                        />
                    </motion.div>

                    {/* Progress Bar Container */}
                    <div className="w-48 sm:w-64 h-1 md:h-1.5 bg-white/5 rounded-full overflow-hidden backdrop-blur-sm ring-1 ring-white/10">
                        <motion.div
                    ...
                    >
                        <span className="text-white/80 text-base md:text-lg font-light tracking-[0.3em] md:tracking-[0.5em] uppercase">Loading</span>
